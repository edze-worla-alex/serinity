...
export const metadata: Metadata = {
  title: {
    default: "Nunyui Luxury Spa & Salon | Premier Wellness in Volta",
    template: "%s | Nunyui Luxury Spa & Salon",
  },
  description: "Experience unparalleled luxury spa and salon services in Volta. Professional hair styling, advanced skincare, therapeutic massage, premium nail care, and wellness treatments with state-of-the-art equipment.",
  keywords: "luxury spa, salon services, hair styling, skincare, massage, nail care, wellness, Volta, Nunyui",
  authors: [{ name: "Nunyui Luxury Spa & Salon" }],
  creator: "Nunyui Luxury Spa & Salon",
  publisher: "Nunyui Luxury Spa & Salon",
  openGraph: {
    title: "Nunyui Luxury Spa & Salon | Premier Wellness in Volta",
    description: "Volta's premier luxury wellness destination. Unparalleled service with highly skilled professionals and state-of-the-art equipment.",
    url: "https://nunyuispa.com",
    siteName: "Nunyui Luxury Spa & Salon",
    images: [
      {
        url: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/287fd6130_13.jpg?w=1200&q=90",
        width: 1200,
        height: 630,
        alt: "Nunyui Luxury Spa & Salon",
      },
    ],
    locale: "en_IN",
    type: "website",
  ...
  twitter: {
    ...
    title: "Nunyui Luxury Spa & Salon | Premier Wellness in Volta",
    description: "Experience luxury spa and salon services in Volta. Book your appointment today!",
  ...
  metadataBase: new URL("https://nunyuispa.com"),
};
